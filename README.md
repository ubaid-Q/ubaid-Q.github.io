...
<html lang="en">
  <head>
    ...
    <title>Logic Konnect Solutions.</title>
    ...
    <header id="header" class="header fixed-top">
      ...
      >
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          <img style="margin-top: 10px" src="./assets/img/logo.png" alt="" />
        </a>
        ...
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center">
            ...
            <h2 data-aos="fade-up" data-aos-delay="400">
              We are team of talented software engineers making innovative
              applications
            </h2>
    ...
    <main id="main">
          ...
          <div class="row gx-0">
            ...
            >
              <div class="content">
                <h3>Who We Are</h3>
                <h2>
                  We have the expertise and resources to deliver the results you
                  need.
                </h2>
                <p>
                  Logic Konnect Solutions is a cutting-edge IT company that
                  offers innovative solutions to modern business challenges.
                  With a team of experienced and knowledgeable professionals, we
                  help businesses streamline their processes, improve their
                  efficiency, and stay ahead of the competition. Whether you're
                  looking for custom software development, cloud computing
                  services, cyberse- curity solutions, or anything in between.
                </p>
                <div class="text-center text-lg-start">
                  <a
                    href="#"
      ...
      <section id="services" class="services">
        <div class="container" data-aos="fade-up">
          <header class="section-header">
            <h2>Services</h2>
            <p>Logic Konnect Provides Multiple IT Services</p>
          </header>
          <div class="row gy-4">
            <div
            ...
            >
              <div class="service-box blue">
                ...
                <h3>DevOps and Server Operations</h3>
                <p style="text-align: justify">
                  We are here to manage the organization's software development,
                  deployment, and maintenance. Our DevOps engineers and — system
                  administrators are proficient in technologies such as to
                  providing reliable and secure server operations. while
                  continuously optimizing our systems for maximum performance
                  and scalability. Our team is committed to providing
                  world-class service and support to all of our customers.
                </p>
            ...
            >
              <div class="service-box orange">
                <i class="ri-discuss-line icon"></i>
                <h3>Enterprise's B2B Services</h3>
                <p style="text-align: justify">
                  Enterprises B2B services are designed to help businesses of
                  all sizes to Improve their operations and increase their
                  profits. We offer a wide range of services, including business
                  consul- ting, marketing strategy development, product and
                  service marketing, supply chain optimization, digital
                  transformation, and more. Our team of experienced
                  professionals is dedica- ted to providing our clients with the
                  best possible solutions for their business needs. We strive to
                  provide our clients with the highest quality solutions that
                  ...
                  <div class="info-box">
                    ...
                    <p>
                      ...
                      ><br /><a
                        href="/cdn-cgi/l/email-protection"
                        class="__cf_email__"
                        data-cfemail="7b1814150f1a180f3b1e031a160b171e55181416"
                        >[email&#160;protected]</a
                      >
                    </p>
                  </div>
        ...
        <div class="container">
          <div class="row gy-4">
            <div class="col-lg-5 col-md-12 footer-info">
              <a href="index.html" class="logo d-flex align-items-center">
                <img src="assets/img/logo.png" alt="" /> <span>FlexStart</span>
              </a>
              <p>
