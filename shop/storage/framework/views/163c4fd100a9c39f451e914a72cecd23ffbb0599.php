                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. <?php echo e($currentMonthSale); ?></div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. <?php echo e($todaySale); ?></div>
                                <div class="mt-2 mb-0 text-muted text-xs">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. <?php echo e($expenseToday); ?></div>
                                <div class="mt-2 mb-0 text-muted text-xs">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubaid/Desktop/M-shop/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>